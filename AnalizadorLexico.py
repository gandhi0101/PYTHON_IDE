...
while i < len(contenidodecodigo):
    ...
    if contenidodecodigo[i : i + 2] in operadores_relacionales:
        ...
        i += 1
        continue
    if contenidodecodigo[i : i + 2] in operadores_logicos:
        tokens.append(" " + contenidodecodigo[i : i + 2] + " --* operador logico --*")
        i += 2
        col += 2
        continue
    elif contenidodecodigo[i] in operadores_logicos:
        tokens.append(" " + contenidodecodigo[i] + " --* operador logico --*")
        i += 1
        continue
