...
class MenuHandler:
	def __init__(self, parent):
		...
		try:
			...
			if is_mac:
				self.additionalMenu = self.parent.menuBar().addMenu('More Options')
			...
			print(f"Error al crear el menú 'File': {e}")
		...
		try:
			...
			print(f"Error al crear el menú 'Edit': {e}")

		try:
			# Agregar iconos y acciones al menú
			...
			print(f"Error al agregar iconos al menú: {e}")

		try:
			# Crear y agregar la opción "Close"
			...
			print(f"Error al agregar la opción 'Close': {e}")
		...
		try:
			...
			print(f"Error al agregar un separador: {e}")

		try:
			# Crear acciones para el análisis léxico, sintáctico, semántico y compilador
			...
			if is_mac:
				self.additionalMenu.addAction(self.lexicalMenu)
				self.additionalMenu.addAction(self.syntaxMenu)
				self.additionalMenu.addAction(self.semanticMenu)
				self.additionalMenu.addAction(self.compilerMenu)
			else:
			...
			print(f"Error al agregar los menús de análisis: {e}")
